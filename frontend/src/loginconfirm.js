...
function Login() {
  ...
  const [currentPage, setcurrentPage] = context["currentpage"]
    ...
    const login =()=>{
      ...
      axios.get(`https://new-frugetbackend-production.up.railway.app/client/login?email=${inputs.email}&password=${inputs.password}&print=${realprint}`)
      .then(res =>{
       ...
       <small style={{fontSize:"50px",padding:"50px"}}>
          ...
          <div className="logindiv">
              ...
              <div >
                ...
                <input  type="text" placeholder="Username Or Email" onChange={change} name="email" style={{backgroundColor:"rgb(38, 38, 38)",color:"lightgrey"}} className='logininput form-control' />
                <br/>
                ...
                <input  type={`${passtype}`} onChange={change} name="password" placeholder="Enter Your Password" style={{backgroundColor:"rgb(38, 38, 38)",border:"none",color:"lightgrey"}} className='form-control' />
