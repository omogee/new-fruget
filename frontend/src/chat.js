...
function Chatus(props) {
    ...
    const [savedmessages, setsavedmessages] = useState({})
     ...
     useEffect(()=>{
      ...
      axios.get(`https://new-frugetbackend-production.up.railway.app/fetch_messages?tkt=${Cookies.get("tktplc")}&pdx=${query.get("pdx")}`)
      .then(res => {
    ...
    axios.get(`https://new-frugetbackend-production.up.railway.app/fetch_user?pdx=${query.get("pdx")}`)
  .then(res => {
    if(res.data.status === "success"){
