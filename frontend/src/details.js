     ...
     if (Cookies.get("tktplc")){
       setloading(true)
        const print =[
            ...
            axios.get(`https://new-frugetbackend-production.up.railway.app/client/auth_user?tkt=${Cookies.get("tktplc")}&nayv=${realprint}`)
            .then(res=>{
...
useEffect(()=>{
 ...
 axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_details?tkt=${Cookies.get("tktplc")}&details=${params.productDetails}&productId=${query.get("pid")}`)
 .then(res =>{ 
...
const saveItem=(properties)=>{  
   ...
   if(Cookies.get("tktplc")){
    ...
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/save_item?tkt=${Cookies.get("tktplc")}&productId=${productDetails.pid}`)
    .then(res =>{
        if(res.data.status === "success"){
...
const unsaveItem=(properties)=>{  
   ...
   if(Cookies.get("tktplc")){
    const tkt = Cookies.get("tktplc")
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/unsave_item?tkt=${Cookies.get("tktplc")}&productId=${productDetails.pid}`)
    .then(res =>{
        if(res.data.status === "success"){
            setsavedProducts(res.data.savedItems)
...
setloading(true)
if(Cookies.get("tktplc")){
axios.get(`https://new-frugetbackend-production.up.railway.app/item/confirm_productratemodal?productId=${productDetails.productId}&tkt=${Cookies.get("tktplc")}`)
.then(res =>{
  if(res.data.status === "success"){
    query.set("rate",true);
    setratemodaldisplay(true)
...
const rate=()=>{
    ...
    const print =[
        ...
        const mainprint =JSON.stringify(print).replace(/[&\/\\#,;+()$~%.'":*?<>{}]/g, '')
        const realprint = mainprint.substring(1, mainprint.length-1)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/rate?productId=${productDetails.pid}&ratingsinput=${JSON.stringify(ratinginputs)}&tkt=${Cookies.get("tktplc")}&nayv=${realprint}`)
    .then(res =>{
        if(res.data.status === "success"){
      setproductcomments(res.data.comments)
      setavgrating(res.data.avgrating[0])
...
const addtocart=()=>{
    ...
    const print =[
        ...
        const mainprint =JSON.stringify(print).replace(/[&\/\\#,;+()$~%.'":*?<>{}]/g, '')
        const realprint = mainprint.substring(1, mainprint.length-1)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/addtocart?productId=${productDetails.pid}&tkt=${Cookies.get("tktplc")}&dispatch=${JSON.stringify(availabledispatchers[0])}&nayv=${realprint}`)
   .then(res =>{
    if(res.data.status === "success"){    
...
const followstore=(store)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/follow_store?store=${escape(store)}&tkt=${Cookies.get("tktplc")}`)
    .then(res => {
      if(res.data.status === "success"){
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_details?tkt=${Cookies.get("tktplc")}&details=${params.productDetails}&productId=${query.get("pid")}`)
 .then(res =>{ 
...
setloading(false)
 ...
 .catch(err => console.log(err))
   ...
   const unfollowstore=(store)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/unfollow_store?store=${escape(store)}&tkt=${Cookies.get("tktplc")}`)
    .then(res => {
      if(res.data.status === "success"){
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_details?tkt=${Cookies.get("tktplc")}&details=${params.productDetails}&productId=${query.get("pid")}`)
 .then(res =>{ 
...
setloading(false)
 ...
 .catch(err => console.log(err))
   ...
   const followdispatch=(dispatchId)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/follow_dispatch?dispatchId=${dispatchId}&tkt=${Cookies.get("tktplc")}`)
    .then(res => {
      if(res.data.status === "success"){
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_details?tkt=${Cookies.get("tktplc")}&details=${params.productDetails}&productId=${query.get("pid")}`)
 .then(res =>{ 
...
setloading(false)
 ...
 .catch(err => console.log(err))
   ...
   const unfollowdispatch=(dispatchId)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/unfollow_dispatch?dispatchId=${dispatchId}&tkt=${Cookies.get("tktplc")}`)
    .then(res => {
      if(res.data.status === "success"){
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_details?tkt=${Cookies.get("tktplc")}&details=${params.productDetails}&productId=${query.get("pid")}`)
 .then(res =>{ 
...
const likecomment=(productratingId)=>{
 if(Cookies.get("tktplc")){
  axios.get(`https://new-frugetbackend-production.up.railway.app/item/like_productcomment?tkt=${Cookies.get("tktplc")}&productratingId=${productratingId}`)
  .then(res => {
    if(res.data.status === "success"){
      setproductcomments(res.data.comments)
    }
...
const dislikecomment=(productratingId)=>{
  if(Cookies.get("tktplc")){
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/dislike_productcomment?tkt=${Cookies.get("tktplc")}&productratingId=${productratingId}`)
    .then(res => {
      if(res.data.status === "success"){
        setproductcomments(res.data.comments)
      }
...
51% Energy Saving In Refrigerator with Inverter Linear Compressor(ILC).
 ...
 Actual Results may vary from model to model and also depends upon the kind of usage under general conditions.
         ...
         {productDetails.img1 && productDetails.featuresimg !== null && JSON.parse(productDetails.img1)[2] !== undefined ? Object.keys(JSON.parse(productDetails.featuresimg)).map(featureimg =>
