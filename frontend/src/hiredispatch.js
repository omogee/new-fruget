...
const fetchcomments =(dispatchId)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_dispatchcomments?dispatchId=${dispatchId}`)
    .then(res =>{
...
const followdispatch=(dispatchId)=>{
   ...
   const add_dispatchcomment=(dispatchId)=>{
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/rate_dispatch?dispatchId=${dispatchId}&tkt=${Cookies.get("tktplc")}&ratinginputs=${JSON.stringify(ratinginputs)}`)
    .then(res =>{
        if(res.data.status==="success"){
            axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_all_dispatch?tkt=${Cookies.get("tktplc")}`)
            .then(res =>{
   ...
   const likecomment=(dispatchratingId)=>{
    if(Cookies.get("tktplc")){
        setloading(true)
     axios.get(`https://new-frugetbackend-production.up.railway.app/item/like_dispatchcomment?tkt=${Cookies.get("tktplc")}&dispatchratingId=${dispatchratingId}`)
     .then(res => {
       if(res.data.status === "success"){
        if(dispatchcomments){
            setdispatchcomments(res.data.dispatchcomments)
   ...
   const dislikecomment=(dispatchratingId)=>{
     if(Cookies.get("tktplc")){
        setloading(true)
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/dislike_dispatchcomment?tkt=${Cookies.get("tktplc")}&dispatchratingId=${dispatchratingId}`)
       .then(res => {
         if(res.data.status === "success"){
           if(dispatchcomments){
            setdispatchcomments(res.data.dispatchcomments)
   ...
   const confirmratestatus=(dispatchId)=>{
     if(Cookies.get('tktplc')){
        setloading(true)
        axios.get(`https://new-frugetbackend-production.up.railway.app/item/confirm_ratedispatchmodal?tkt=${Cookies.get("tktplc")}&dispatchId=${dispatchId}`)
        .then(res=>{
            if(res.data.status === "success"){
