...
const [productcomments, setproductcomments]= context["productcomments"]
 ...
 setInterval(() => {
  ...
  useEffect(()=>{
     // setloading(true)
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_similiar?brand=${props.brand}&category=${props.category}&subcat1=${props.subcat1}&subcat2=${props.subcat2}`)
       .then(res => {
         setTrends(res.data.trends)
...
const [productcomments, setproductcomments]= context["productcomments"]
 ...
 setInterval(() => {
  ...
  useEffect(()=>{
       axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_samesellerproducts?store=${escape(props.store)}`)
       .then(res => {
