 ...
 const [targetmodal, settargetmodal] = context["targetmodal"]
   ...
   useEffect(()=>{
    ...
    if(Cookies.get("tktplc")){
        axios.get(`https://new-frugetbackend-production.up.railway.app/client/cart_status_view?tkt=${Cookies.get("tktplc")}`)
        .then(res => {
...
useEffect(()=>{
    ...
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/fetch_cartreciepts?tkt=${Cookies.get("tktplc")}&order=${query.get("order") || order}`)
    .then(res =>{
        if(res.data.status === "success"){
...
const openinvoice=(data)=>{
    ...
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/fetch_ungroupedcartreciepts?tkt=${Cookies.get("tktplc")}&invoiceNo=${data.invoiceNo}&customerId=${data.customerId}&dispatchId=${data.dispatchId}&order=${query.get("order") || order}`)
    .then(res =>{
        if(res.data.status === "success"){
