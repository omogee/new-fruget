...
useEffect(()=>{
  axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_all_stores`)
  .then( res =>{
...
useEffect(()=>{
 ...
 useEffect(()=>{
  ...
  .catch(err => console.warn(err))
    ...
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_categories`)
    .then(res =>{
  ...
  if(Cookies.get("tktplc")){
    axios.get(`https://new-frugetbackend-production.up.railway.app/fetch_unreadmessages?tkt=${Cookies.get("tktplc")}`)
    .then(res => {
      if(res.data.status){
    ...
    .catch(err => console.warn(err))
      axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_all_dispatch?tkt=${Cookies.get("tktplc")}`)
      .then(res =>{
 ...
 axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_visitedproducts?tkt=${Cookies.get("tktplc")}`)
 .then(res =>{
  if(res.data.status === "success"){
 ...
 axios.get(`https://new-frugetbackend-production.up.railway.app/client/fetch_verified_sales?tkt=${Cookies.get("tktplc")}`)
 .then(res =>{
  if(res.data.status === "success"){
 ...
 useEffect(()=>{
   if(searchinput && searchinput.length > 0 || query.get("search")){
    ...
    setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/search?page=${page || 1}&sorter=${query.get("sby")}&searchinput=${searchinput || query.get("search")}&setting=${query.get("search") ? true : false}`)
    .then(res => {
  ...
  useEffect(()=>{
    if(currentPage === "storeproducts" && storesearchinput.length === 0){
      ...
      setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/item/search/fetch_storeproducts?&storesearchinput=${storesearchinput}&store=${escape(category.store || query.get("store")) || "null"}&brand=${category.brand || query.get("brand")}&page=${page}&tkt=${Cookies.get("tktplc")}`)
    .then(res => {
  ...
  function showError(error) {
   ...
   getpos.then(coord=>{
    if(currentPage === "products" && searchinput.length === 0 && !query.get("search")){
      setproducts([])
      setloading(true)
      axios.get(`https://new-frugetbackend-production.up.railway.app/item?page=${page}&coord=${JSON.stringify(coord)}&tkt=${Cookies.get("tktplc") || null}&brand=${category.brand || query.get("brand")}&sorter=${sorter}&category=${category.category || query.get("cat")}`)
      .then(res => {
        setTimeout(()=> setloading(false), 700)
          setproducts(res.data.products)
          if(res.data.numprod[0] && res.data.numprod[0].numprod > 0){
      ...
      axios.get(`https://new-frugetbackend-production.up.railway.app/item/fetch_storeproducts?store=${(category.store || query.get("store")) || "null"}&coord=${JSON.stringify(coord)}&brand=${category.brand || query.get("brand")}&page=${page}&tkt=${Cookies.get("tktplc")}`)
      .then(res => {
        setTimeout(()=> setloading(false), 700)
          setstoreproducts(res.data.products)
          if(res.data.numprod[0] && res.data.numprod[0].numprod > 0){
  ...
  useEffect(()=>{
    if(Cookies.get("tktplc") && (currentPage !== "login" || currentPage !== "register")){
      setloading(true)
    axios.get(`https://new-frugetbackend-production.up.railway.app/client/fetch_userdetails?tkt=${Cookies.get("tktplc")}`)
    .then(res =>{
       if(res.data.status === "success"){
